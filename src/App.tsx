        ...
        <aside className="panel controls-panel">
          ...
          <div className="control-group">
            <label style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
              OpenAI API Key (Optional) <span title="Used for dynamic GPT-4o-mini generation"><Info size={15} /></span>
            </label>
            <input
              type="password"
              placeholder="sk-proj-..."
            ...
            />
            <small style={{ color: 'var(--muted)', fontSize: '0.75rem', lineHeight: '1.4' }}>
              Allows generating real-time explanations with <strong>gpt-4o-mini</strong>. Saved locally.
            </small>
          </div>
